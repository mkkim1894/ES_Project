...
% makeFigure_StandardFGM — Generate publication-quality Figure for canonical (Standard) FGM.
%
% Usage:
%   makeFigure_StandardFGM(1e-7, 1e-3)
%   makeFigure_StandardFGM(1e-7, 1e-3, 'demo')
%
% Description:
