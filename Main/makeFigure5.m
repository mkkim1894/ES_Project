function makeFigure5(figureType, SSWMRate, CMRate)
    ...
    baseDirs = struct(...
        'SSWM', 'results/Generalization/SSWM', ...
        'CM_Asexual', 'results/Generalization/CM_Asexual', ...
        'CM_Sexual', 'results/Generalization/CM_Sexual');
    ...
    % Save the figure
    saveFigure('figure5', figureWidth, figureHeight);
end
