function [resultPleiotropicCM] = simulatePleiotropicCM(simParams, genomeParams)
    % simulatePleiotropicCM - Simulates the pleiotropic FGM under the concurrent mutation regime.
    % Inputs:
    ...
    %
    % Outputs:
    %   resultPleiotropicCM - Structure containing the results of the simulation.
