...
%   numSteps          - Number of burn-in generations
...
%   simParams.populationMatrices = preRunSimulation(initParams, simParams, 200, 'rngSeed', 1);
%
% Reference:
%   Kim, M., Ardell, S. M., & Kryazhimskiy, S. (2025).
%   "Module-Selection Balance in the Evolution of Modular Organisms."
%
% See also: freezeParam, simulateModularCM
%
