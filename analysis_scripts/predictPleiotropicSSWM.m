...
%   under SSWM dynamics, where each mutation affects both traits with a
%   random pleiotropic angle. The trajectory follows the fitness gradient
%   given by (x1/x10)^(a1^2) = (x2/x20)^(a2^2) and is truncated to match
%   the endpoint of the average simulated trajectory.
%
% Inputs:
