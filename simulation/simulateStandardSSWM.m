...
% simulateStandardSSWM - Simulate standard (isotropic) FGM under SSWM regime.
%
% Description:
%   Runs stochastic simulations of the standard FGM with isotropic mutations
%   (random direction in phenotype space). Serves as a baseline comparison.
%
% Inputs:
%   simParams - Structure containing simulation parameters (see initializeSimParams)
%
% Outputs:
%   resultModularSSWM - Structure with .resultTable containing trajectory matrices
%
% Reference:
%   Kim, M., Ardell, S. M., & Kryazhimskiy, S. (2025).
%   "Module-Selection Balance in the Evolution of Modular Organisms."
%
% See also: simulateStandardCM, simulateModularSSWM
%
