...
%   a distribution determined by the module's dimensionality.
%
% Inputs:
%   simParams - Structure containing simulation parameters including:
%       .moduleDimension - Number of dimensions per module [n1, n2]
%       (See simulateModularSSWM for other parameters)
%
% Outputs:
%   resultNestedSSWM - Structure with .resultTable as in simulateModularSSWM
%
% Reference:
