...
% simulateStandardCM - Simulate standard (isotropic) FGM under CM regime.
%
% Description:
%   Runs Wright-Fisher simulations of the standard FGM with isotropic mutations
...
%
% Outputs:
%   resultModularCM - Structure with .resultTable containing trajectory matrices
%
% Reference:
%   Kim, M., Ardell, S. M., & Kryazhimskiy, S. (2025).
%   "Module-Selection Balance in the Evolution of Modular Organisms."
%
% See also: simulateStandardSSWM, simulateModularCM
%
